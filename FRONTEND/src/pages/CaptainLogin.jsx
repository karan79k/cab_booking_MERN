...
export default function CaptainLogin() {
  ...
  <div className="w-full text-center mt-[-10px] ml-[-5px]">
    <p className="text-xs text-gray-500">captain</p>
        ...
        <div className="flex justify-between items-center mt-4 text-sm text-gray-500">
          ...
          <Link to='/usersignup'>
          <button className="font-normal text-indigo-600 hover:underline cursor-pointer">Join as captain</button>
          </Link>
        </div>
        ...
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className=" mb-0.5 w-full bg-[#04BF45] text-white py-2 rounded-md font-600 hover:bg-lime-900 transition-all text-lg px-10 mt-28"
        >
          Login as user
        </motion.button>
        </Link>
